            ...
            <div className="flex flex-col min-h-screen bg-white">
                ...
                <header className="px-4 lg:px-6 h-16 flex items-center border-b sticky top-0 bg-white/80 backdrop-blur-sm z-50">
                    <div className="flex items-center gap-2 font-bold text-xl text-blue-600">
                        <img src="/logo-bkvolunteers.png" alt="BK Volunteers Logo" className="size-8 object-contain" />
                            ...
                            <div className="flex flex-col items-center space-y-4 text-center">
                                <div className="space-y-2">
                                    <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none text-slate-900">
                                        Kết nối trái tim, <br className="hidden sm:inline" /> 
                                        lan tỏa yêu thương
                                    </h1>
                                    <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                                        Nền tảng quản lý hoạt động tình nguyện hiệu quả dành cho sinh viên Bách Khoa. 
                                        Tham gia ngay để cùng nhau tạo nên những thay đổi tích cực.
                                    </p>
                                </div>
                        ...
                        <div className="container px-4 md:px-6 mx-auto">
                            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        Mọi thứ bạn cần để quản lý và tham gia các hoạt động tình nguyện một cách chuyên nghiệp.
                                    </p>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                <div className="flex flex-col items-center space-y-2 p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <h3 className="text-xl font-bold">Quản lý sự kiện</h3>
                                    <p className="text-center text-gray-500">Dễ dàng tạo, quản lý và theo dõi các chiến dịch tình nguyện tập trung.</p>
                                </div>
                                <div className="flex flex-col items-center space-y-2 p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="p-3 bg-green-100 rounded-full text-green-600 mb-2">
                                        <Users className="size-6" />
                                    </div>
                                    <h3 className="text-xl font-bold">Kết nối thành viên</h3>
                                    <p className="text-center text-gray-500">Giao lưu và phối hợp cùng cộng đồng tình nguyện viên nhiệt huyết.</p>
                                </div>
                                <div className="flex flex-col items-center space-y-2 p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="p-3 bg-purple-100 rounded-full text-purple-600 mb-2">
                                        <ShieldCheck className="size-6" />
                                    </div>
                                    <h3 className="text-xl font-bold">Ghi nhận đóng góp</h3>
                                    <p className="text-center text-gray-500">Chứng nhận hoạt động và tích lũy điểm rèn luyện minh bạch.</p>
                                </div>
                                <div className="flex flex-col items-center space-y-2 p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="p-3 bg-orange-100 rounded-full text-orange-600 mb-2">
                                        <Heart className="size-6" />
                                    </div>
                                    <h3 className="text-xl font-bold">Lan tỏa giá trị</h3>
                                    <p className="text-center text-gray-500">Chia sẻ những câu chuyện ý nghĩa và cảm hứng đến mọi người.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                ...
                                <div className="w-full max-w-sm space-y-2">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Hoàn toàn miễn phí cho sinh viên và các tổ chức phi lợi nhuận.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
                    <p className="text-xs text-gray-500">© 2026 BK Volunteers. Bảo lưu mọi quyền.</p>
